...
async function runParallelSelfPlay(gameCount,maxPlies){
  ...
  const workers=mobile?1:Math.max(1,Math.min(requested,(navigator.hardwareConcurrency||2)-1));
